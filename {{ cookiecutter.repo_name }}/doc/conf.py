...
latex_documents = [
  ('index', '{{ cookiecutter.package_name }}.tex', '{{ cookiecutter.package_name }} Documentation',
...
man_pages = [
    ('index', '{{ cookiecutter.package_name }}', '{{ cookiecutter.package_name }} Documentation',
...
texinfo_documents = [
  ('index', '{{ cookiecutter.package_name }}', '{{ cookiecutter.package_name }} Documentation',
   '{{ cookiecutter.author_name }}', '{{ cookiecutter.package_name }}', 'One line description of project.',
   'Miscellaneous'),
]
